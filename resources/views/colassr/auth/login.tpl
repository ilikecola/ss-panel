...
<body class="login-page"  style="background-image:url('/bg.jpg');position: fixed;background-repeat:no-repeat;width:100%;height:100%;z-index:900;max-width:none;background-size: cover;">
<div class="login-box">
